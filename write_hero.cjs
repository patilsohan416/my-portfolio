...
fs.writeFileSync('c:/Users/Lenovo/Desktop/project/video_portfolio-main/video_portfolio-main/src/components/Hero.jsx', content);
console.log('Hero.jsx written successfully. Length:', content.length);
